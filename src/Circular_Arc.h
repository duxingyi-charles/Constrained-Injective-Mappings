...
public:
    ...
    VarVec2d get_out_tangent_vector() const;
    // compute the vector tangent to the arc at start point
    VarVec2d get_in_tangent_vector() const;
    ...
    var get_arc_angle() const { return arc_angle; }
    var get_start_angle() const { return start_angle; }
    var get_end_angle() const { return end_angle; }
    Point  get_center() const { return center; }
    var get_radius() const { return radius; }
